...
the_ch = " "    # avalin character space bashad
the_col = 0
the_line = 1
input_file = None
...
#*** gereftane chaaracter dar input
def next_ch():
...
def char_lit(err_line, err_col):
    n = ord(next_ch())              # baraye skip kardane qoutation
    if the_ch == '\'':
...
#*** handle kardane shenase ha va integer ha
